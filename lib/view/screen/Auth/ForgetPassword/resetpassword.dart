...
class resetpassword extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    resetpasswordcontrollerTmp controller=Get.put(resetpasswordcontrollerTmp());
  // TODO: implement build
  return Scaffold(
  appBar: AppBar(
  centerTitle: true,
  backgroundColor: AppColor.backgroundcolor,elevation: 0.1,
  title: Text("reset".tr,style: Theme.of(context).textTheme.headline1!.copyWith(color:AppColor.grey ),),
  ),
  ...
  SizedBox(height: 5,),
  CustomeTextheadAuth(title: "resetttitle".tr,),


  SizedBox(height: 15,),

    CustomeTextFormAuth(hittext:"hitlableRP".tr ,hitlable:"hittextRP".tr ,icondata: Icons.lock_clock_outlined,mycontroller: controller.password,),

    CustomeTextFormAuth(hittext:"hittextRP2".tr ,hitlable:"hitlableRP2".tr ,icondata: Icons.lock_clock_outlined,mycontroller: controller.repassword,),

/*              InkWell(child: Text("forget".tr,style: TextStyle(color: AppColor.primary,fontWeight: FontWeight.bold),),),
*/
  CustomButtomAuth(text: "resetbtn".tr,onPressed: (){
